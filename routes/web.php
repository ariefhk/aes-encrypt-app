...
Route::get('/encrypt/{id}/decrypt', [Controllers\FileController::class, 'showDecryptFromEncrypt'])->name('encrypt.decrypt');
Route::get('/decrypt/{id}/encrypt', [Controllers\FileController::class, 'showEncryptFromDecrypt'])->name('decrypt.encrypt');
...
Route::get('/file/{id}/download', [Controllers\FileController::class, 'download'])->name('file.download');
